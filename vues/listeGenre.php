...
<table class="table table-hover table-striped">
  ...
  foreach($LesGenres as $genre){
    echo"<tr class='d-flex'>";
     ...
     <a href='#SupprimerModal' data-toggle='modal' data-message='Vous voulez vous supprimer cette Nationalité ?' data-suppression='index.php?uc=genres&action=delete&num=".$genre->getNum()."' class='btn btn-primary'><i class='far fa-trash-alt'></i></a>
     </td>";
    echo"</tr>";
    }
